...
/// @param[out] y The spectral flux or uncertainty data (previous content is
/// overwritten).
/// @param[in] skip The number of leading lines to skip (optional).
///
/// @return the input stream.
std::istream &get (std::istream &is, std::valarray<real> &x,
                   std::valarray<real> &y, natural skip = 0);
...
/// @param[out] z The spectral flux uncertainty data (previous content is
/// overwritten).
/// @param[in] skip The number of leading lines to skip (optional).
///
/// @return the input stream.
std::istream &get (std::istream &is, std::valarray<real> &x,
                   std::valarray<real> &y, std::valarray<real> &z,
                   natural skip = 0);
