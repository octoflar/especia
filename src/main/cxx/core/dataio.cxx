...
istream &
especia::get (istream &is, valarray<real> &x, valarray<real> &y, natural skip)
{
...
istream &
especia::get (istream &is, valarray<real> &x, valarray<real> &y,
              valarray<real> &z, natural skip)
{
  const size_t room = 20000;
...
ostream &
especia::put (ostream &os, const valarray<real> &x, const valarray<real> &y,
              const valarray<real> &z)
{
  if (os)
    {
