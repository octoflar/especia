...
void
write_usage_message (ostream &os, const string &program_name)
{
  os << "usage: " << program_name
     << " {flux file} {uncertainty file} [lines to skip] [> {target file}]"
     << endl;
}
...
///
/// @c argv[3] The number of lines to skip at the beginning (optional, default
/// = 0).
/// @endparblock
/// @return an exit code.
///
/// @remark Usage: ezip {flux file} {uncertainty file} [lines to skip] [>
/// {target file}]
int
