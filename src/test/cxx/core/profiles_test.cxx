...
private:
  void
  test_equivalent_width_intergalactic_doppler ()
  {
    ...
    assert_equals (real (0.698785), w, real (1.0E-06),
                   "equivalent width (intergalactic Doppler)");
  }

  void
  test_equivalent_width_many_multiplet ()
  {
    ...
    // <https://www.wolframalpha.com/input/?i=NIntegrate%5B1-Exp%5B-1%2F(0.5+Sqrt%5BPi%5D)+Exp%5B-(x%2F0.5)%5E2%5D%5D,+%7Bx,+-Infinity,+Infinity%7D%5D>
    assert_equals (real (0.698785), w, real (1.0E-06),
                   "equivalent width (many-multiplet)");
  }

  void
  test_equivalent_width_intergalactic_voigt ()
  {
    ...
    assert_equals (real (0.881143), w, real (5.0E-03),
                   "equivalent width (intergalactic Voigt)");
  }

  void
  test_equivalent_width_intergalactic_voigt_extended ()
  {
    using especia::Extended_Pseudo_Voigt;
    using especia::Intergalactic_Voigt;

    const real w
        = calculator.calculate (Intergalactic_Voigt<Extended_Pseudo_Voigt> ());

    // <https://www.wolframalpha.com/input/?i=NIntegrate%5B1+-+Exp%5B-PDF%5BVoigtDistribution%5B0.5,+0.5%2FSqrt%5B2%5D%5D,+x%5D%5D,+%7Bx,+-Infinity,+Infinity%7D%5D>
    assert_equals (real (0.881143), w, real (5.0E-03),
                   "equivalent width (intergalactic Voigt, extended)");
  }

  void
  test_maximum_pseudo_voigt ()
  {
    using especia::Pseudo_Voigt;

    // <https://www.wolframalpha.com/input/?i=PDF%5BVoigtDistribution%5B0.5,+0.5%2FSqrt%5B2%5D%5D,+0%5D>
    assert_equals (real (0.482476), Pseudo_Voigt (0.5, 0.5) (0.0),
                   real (1.0E-03),
    ...
    assert_equals (real (0.241238), Pseudo_Voigt (1.0, 1.0) (0.0),
                   real (1.0E-03),
                   "Voigt function maximum (pseudo-Voigt approximation)");
  }

  void
  test_maximum_pseudo_voigt_extended ()
  {
    using especia::Extended_Pseudo_Voigt;

    // <https://www.wolframalpha.com/input/?i=PDF%5BVoigtDistribution%5B0.5,+0.5%2FSqrt%5B2%5D%5D,+0%5D>
    assert_equals (
        real (0.482476), Extended_Pseudo_Voigt (0.5, 0.5) (0.0),
        real (5.0E-04),
        "Voigt function maximum (extended pseudo-Voigt approximation)");

    // <https://www.wolframalpha.com/input/?i=PDF%5BVoigtDistribution%5B1.0,+1.0%2FSqrt%5B2%5D%5D,+0%5D>
    assert_equals (
        real (0.241238), Extended_Pseudo_Voigt (1.0, 1.0) (0.0),
        real (5.0E-04),
        "Voigt function maximum (extended pseudo-Voigt approximation)");
  }
  ...
  run_all () override
  {
    ...
    run (this,
         &Profiles_Test::test_equivalent_width_intergalactic_voigt_extended);
